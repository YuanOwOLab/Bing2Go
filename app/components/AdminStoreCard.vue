    ...
    >
        ...
        <div class="flex-grow-1 min-w-0">
            <div class="d-flex align-center mb-1 flex-wrap">
                <div class="text-subtitle-1 text-sm-h6 font-weight-bold text-truncate mr-2 mr-sm-3 text-high-emphasis">
                    {{ name }}
                </div>
                <v-chip
                    v-if="rating > 0"
            ...
            <div
                class="text-caption text-sm-body-2 text-medium-emphasis d-flex align-center flex-wrap gap-2 gap-sm-4 mt-1 mt-sm-2"
            >
