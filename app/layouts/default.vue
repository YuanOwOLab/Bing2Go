                ...
                <v-list>
                    ...
                    >
                        <v-list-item-title>
                            ...
                            <v-badge
                                v-if="
                                    (link.value === 'customer-orders' || link.value === 'delivery-orders') &&
            ...
            <v-app-bar app color="white" flat border>
                ...
                <v-tooltip v-if="role === 'customer'" text="購物冰箱" location="bottom">
                    <template #activator="{ props: act }">
                        <v-btn icon to="/customer/cart" v-bind="{ ...act, ref: setFridgeIcon }">
                            <v-badge
...
.cart-shake {
    animation: cart-shake-anim 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) both;
}
