                ...
                <template v-else>
                    <v-card class="mb-8 rounded-lg border-none elevation-2">
                        <v-card-text class="pt-8 pb-6 px-6">
                            <v-stepper v-model="currentStep" alt-labels flat class="elevation-0" bg-color="transparent">
                                <v-stepper-header>
                    ...
                    <v-row>
                        <v-col cols="12" md="6">
                            <v-card class="mb-4 rounded-lg h-100 elevation-2">
                                <v-card-title
                                    class="d-flex align-center text-h5 font-weight-bold text-grey-darken-3 bg-grey-lighten-5 py-4 px-6"
                                >
                                ...
                                <v-list lines="two" class="py-4 px-2">
                                    ...
                                    <v-list-item v-if="orderData.deliveryStatus === 'on_the_way'">
                                        ...
                                        <v-list-item-subtitle class="text-subtitle-1 text-high-emphasis">
                                            {{ etaTimeString || (isEtaLoading ? "計算中..." : "無法取得") }}
                                        </v-list-item-subtitle>
                                    </v-list-item>
                                </v-list>
                            </v-card>
                        ...
                        <v-col cols="12" md="6">
                            <v-card class="mb-4 rounded-lg h-100 elevation-2">
                                ...
                                <div
                                    v-else
                                    class="fill-height d-flex flex-column align-center justify-center pa-10 text-center"
                    ...
                    <v-card class="mb-8 rounded-lg elevation-2">
                                    ...
                                    <tr v-for="item in orderData.items" :key="item._id">
                                        <td class="pl-8 py-4" style="vertical-align: top">
                                            <div class="text-h6 font-weight-bold text-high-emphasis">
                                                {{ item.name }}
                                                <span class="text-subtitle-1 text-grey-darken-1 mt-1"
                                        ...
                                        <td class="py-4" style="vertical-align: top">
                                            ...
                                            <div class="text-subtitle-1 text-grey-darken-2 mt-1 d-flex align-center">
                                                <v-icon size="small" class="mr-2 mt-1" color="grey"
                                        ...
                                        <td
                                            class="text-right pr-8 py-4 font-weight-bold text-h6"
                        ...
                        <v-card-text class="pa-8 bg-grey-lighten-5">
                            <v-row dense justify="end">
                                <v-col cols="6" sm="4" md="3" class="text-right text-h6 text-grey-darken-1"
                                    >小計：</v-col
                                >
                                <v-col cols="6" sm="4" md="3" class="text-right text-h6 font-weight-bold"
                                    >${{ orderData.total - orderData.deliveryFee }}</v-col
                                >
                            </v-row>
                            ...
                            <v-row dense justify="end" align="center">
                                <v-col
                                    ...
                                    sm="4"
                                    md="3"
                                    class="text-right text-h5 font-weight-bold text-grey-darken-3"
                                    >總計：</v-col
                                >
                                <v-col
                                    cols="6"
                                    sm="4"
                                    md="3"
                                    class="text-right text-h4 font-weight-black text-green-darken-3"
                                    >NT$ {{ orderData.total }}</v-col
                                >
                            </v-row>
                        </v-card-text>
                    </v-card>
...
const {
    ...
    pending,
    error,
} = await useFetch<ApiResponse>("/api/admin/orders", {
    method: "GET",
...
const isEtaActive = computed(
    () => Boolean(courierPosition.value && customerPosition.value) && orderData.value?.deliveryStatus === "on_the_way",
);
