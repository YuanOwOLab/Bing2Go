    ...
    <v-container class="py-8">
        ...
        <v-row align="center" justify="space-between" class="mb-8">
            <v-col cols="12" md="6">
                ...
                <p class="text-subtitle-1 text-medium-emphasis mt-1">管理所有餐廳資訊、菜單與營業狀態</p>
            </v-col>
        ...
        <template v-else>
            ...
            <v-row v-if="stores.length > 0">
                <v-col v-for="store in stores" :key="store._id" cols="12" class="py-2">
                    <AdminStoreCard
                        :id="store._id"
                        :name="store.name"
                        :image="store.image"
            ...
            >
                ...
                <v-btn color="primary" variant="flat" prepend-icon="mdi-plus" to="/admin/stores/new">
                    新增第一間餐廳
                </v-btn>
            </v-sheet>
        </template>
