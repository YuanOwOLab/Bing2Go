                    ...
                    <v-card elevation="2" rounded="lg" class="overflow-visible">
                        ...
                        <v-card-text class="pa-4 pa-md-8">
                            ...
                            <v-slide-y-transition group tag="div">
                                <div v-for="(item, index) in menuItems" :key="item._key" class="mb-6">
...
const saveStore = async () => {
    ...
    try {
        ...
        const restaurantResponse = await $fetch<RestaurantApiResponse>(`/api/admin/restaurants`, {
            method: "POST",
            headers,
            body: storeFormData,
        });
        ...
        if (menuItems.value.length > 0) {
            ...
            for (const item of menuItems.value) {
                ...
                menuPromises.push(
                    $fetch(`/api/admin/restaurants/${newRestaurantId}/menu`, {
                        method: "POST",
                        headers,
                        body: menuFormData,
                    }),
