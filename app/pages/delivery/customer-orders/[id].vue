            ...
            <v-col cols="12">
                ...
                <template v-else key="content">
                    <v-card flat border rounded="xl">
                        <v-card-title class="text-h5 font-weight-bold pt-6 px-6"> 新訂單 #{{ shortId }} </v-card-title>
                        ...
                        <v-card-text class="pl-6 pr-6">
                            ...
                            <v-row>
                                ...
                                <v-col cols="12" sm="8">
                                    ...
                                    >
                                        <div class="text-body-1 text-primary-darken-1 font-weight-bold">
                                            ...
                                            <div class="text-body-1 font-weight-regular text-primary-darken-1 ms-1">
                                                ...
                                                <span
                                                    class="text-body-1 font-weight-regular text-primary-darken-1 ms-1"
                                                >
                                                    {{ restaurant.phone }}
                                                </span>
                                            </div>
                                    ...
                                    <div
                                        v-if="uniqueRestaurants.length === 0"
                ...
                <v-dialog v-model="isPhoneMissing" max-width="450" persistent>
                    <v-card>
                        <v-card-title class="text-h5 font-weight-bold"> 請先填寫聯絡電話 </v-card-title>
                        <v-card-text>
...
const acceptOrder = async () => {
    ...
    try {
        const response: any = await $fetch(`/api/orders/${orderId}/accept`, {
            method: "PATCH",
            headers: {
                Authorization: `Bearer ${userStore.token}`,
